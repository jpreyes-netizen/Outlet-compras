...
export async function registrarRecepcionEnCompras({ ocId, tipoDoc, numeroDoc, fecha, items, cu, rolLabel, notas, archivoUrl = null, archivoNombre = null, logRecId = null }) {
