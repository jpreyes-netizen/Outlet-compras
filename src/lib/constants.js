...
// hora() debe ser DETERMINISTA: se escribe en columnas `time` de Postgres.
// toLocaleTimeString('es-CL') cambió con ICU y pasó a devolver "11:14 p. m.",
// que Postgres rechaza (time zone "p." not recognized) y rompía el puente
// Logística→Compras. Mismo formato que el helper de App.jsx: HH:MM:SS 24h.
export const hora = () => { const d = new Date(); return String(d.getHours()).padStart(2,"0")+":"+String(d.getMinutes()).padStart(2,"0")+":"+String(d.getSeconds()).padStart(2,"0") }
