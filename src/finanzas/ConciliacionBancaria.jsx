...
import { fetchVinculados, fetchFacturasCandidatas, vincularRespaldo, desvincular, extraerRut } from './conciliacion/api_conciliar'
...
export function ConciliacionBancaria({ cu }) {
  ...
  const cargar = useCallback(async () => {
    ...
    if (!anioCompleto) q = q.gte('fecha', mes + '-01').lte('fecha', mes + '-31')
