...
export function EerrEstadoResultados() {
  ...
  const valores = useMemo(() => {
    ...
    // Mergear RRHH sobre las 4 líneas REM_* (devengado, costo empresa con aportes patronales)
              ...
              <tbody>
                {ORDEN_CODIGOS.map(codigo => {
                  ...
                  return (
                    ...
                    {codigo === 'IVA_SII' && (
                      <tr>
                        <td colSpan={14} style={{ padding: '10px 10px 4px', fontSize: 10, fontWeight: 700, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.05em', borderTop: '2px solid #E5E7EB', position: 'sticky', left: 0, background: '#fff' }}>
