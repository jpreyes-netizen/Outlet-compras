...
export function FinPresupuesto({ cu, isMobile }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      {/* Aviso de descuadre conocido BSALE ↔ Supabase (issue 2026-06) */}
      <div style={{
        borderRadius: 8, border: '1px solid #FCD34D', background: '#FEF3C7',
        ...
        <div style={{ flex: 1, lineHeight: 1.5 }}>
          <b>Aviso:</b><br/>
          <b>1.</b> <b>Ventas:</b> El valor "Real" para ventas viene de <code style={{ background: '#FDE68A', padding: '0 4px', borderRadius: 3 }}>ventas_bsale_dia</code>, que actualmente subreporta vs BSALE (mayo 2026: $591M vs $635M). Pendiente arreglar pipeline.<br/>
          <b>2.</b> <b>Remuneraciones:</b> Las 4 líneas REM_* ahora se calculan desde RRHH (<code style={{ background: '#FDE68A', padding: '0 4px', borderRadius: 3 }}>v_rrhh_master</code> + aportes patronales prorrateados). Es el costo empresa real (devengado), no lo pagado por banco. REM_PREVIRED eliminado.
        </div>
      </div>
      ...
      {/* KPIs compactos + alertas top 3 (Fase 2) */}
      {!loading && realData && (
        <>
