    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, lineHeight: 1.5 }}>
          <b>Aviso: descuadre conocido BSALE ↔ Supabase.</b> El valor "Real" mostrado proviene de <code style={{ background: '#FDE68A', padding: '0 4px', borderRadius: 3 }}>ventas_bsale_dia</code> en Supabase, que actualmente subreporta vs el Resumen de BSALE (en mayo 2026: $591M vs $635M). El presupuesto y el cruce están bien — el problema es la sincronización de la edge <code style={{ background: '#FDE68A', padding: '0 4px', borderRadius: 3 }}>bsale-ventas-dia</code>. Pendiente arreglar en sesión aparte.
        </div>
      </div>
