...
const hp = (u, p) => { if(!u) return false; if(u.rol==="admin") return true; const perms=["aprobar_fin","ver_fin","ver_finanzas_app"]; return perms.includes(p) ? ["admin","dir_finanzas","dir_general"].includes(u.rol) : false }
