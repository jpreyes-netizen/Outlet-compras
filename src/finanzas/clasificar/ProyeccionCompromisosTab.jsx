...
import { MotionRoot, TiltCard, AnimatedNumber } from './flujoUI'
...
export function ProyeccionCompromisosTab({ anio, setAnio }) {
  ...
  return (
    <MotionRoot>
      ...
      {/* Toolbar */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', background: '#fff', padding: 12, borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)' }}>
      ...
      {sub === 'semanal' && (
        engineLoading ? (
          ...
          <>
            ...
            <div style={{ background: '#fff', borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)', padding: '16px 14px 6px' }}>
            ...
            {/* Tabla semanal */}
            <div style={{ background: '#fff', borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)', overflow: 'hidden' }}>
      ...
      {sub === 'parametros' && <>
        ...
        <div style={{ background: '#fff', padding: 14, borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)' }}>
        ...
        {/* Umbral */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: '#fff', padding: 14, borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)', flexWrap: 'wrap' }}>
        ...
        {/* Impuestos manual */}
        <div style={{ background: '#fff', borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)', padding: 16 }}>
...
function Kpi({ label, value, color, sub, highlight }) {
  return (
    <TiltCard style={{ padding: '14px 16px', background: highlight ? `linear-gradient(135deg, ${color}16, ${color}2b)` : 'rgba(255,255,255,0.96)', border: highlight ? `1px solid ${color}44` : '1px solid rgba(255,255,255,0.7)' }}>
      <div style={{ fontSize: 10, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.04em' }}>{label}</div>
      <AnimatedNumber value={value} format={fmtCLPplano} style={{ display: 'block', fontSize: 19, fontWeight: 800, color, marginTop: 3 }} />
