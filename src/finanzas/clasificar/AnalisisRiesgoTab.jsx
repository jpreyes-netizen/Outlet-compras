...
import { MotionRoot, TiltCard, GlassPanel } from './flujoUI'
...
export function AnalisisRiesgoTab({ anio, setAnio }) {
  ...
  return (
    <MotionRoot>
      ...
      {/* Toolbar */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', background: '#fff', padding: 12, borderRadius: 10, boxShadow: '0 6px 22px rgba(15,40,80,0.08)' }}>
      ...
      <TiltCard intensity={4} style={{ padding: '16px 14px 6px' }}>
