...
const STOP_PAT = new Set(['DE','DEL','LA','EL','LOS','LAS','Y','A','AL','EN','POR','PARA','CON','SIN','TRANSF','TRANSFERENCIA','PAGO','ABONO','CARGO','COMPRA'])
    ...
    ;(async () => {
      try {
        ...
        for (const [pat, subs] of conteo) {
          ...
          if (!mejor || totalVeces < 2) continue  // mínimo 2 ocurrencias para considerar patrón
          const consistencia = mejor.veces / totalVeces  // 0..1
          patronesMap.set(pat, {
