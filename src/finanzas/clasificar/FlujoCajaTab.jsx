  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ borderRadius: 8, border: '1px solid #BFDBFE', background: '#EFF6FF', padding: '9px 13px', fontSize: 11, color: '#1E40AF', lineHeight: 1.5, display: 'flex', gap: 8, alignItems: 'flex-start' }}>
        ...
        <div>
          Este flujo refleja la <b>cuenta Santander</b>. Los pagos a proveedores extranjeros vía Global66 aparecen como el <b>traspaso a Global66</b>, no como pago individual. Las cuotas de créditos aparecen completas (capital + interés). El detalle de Global66 está en <b>Cartolas → Global66</b>; el desglose capital/interés en <b>EERR → Créditos</b>.
        </div>
      </div>
