...
import { ImportadorCartola } from './tesoreria/CartolaBancariaTab'
...
export function FinConciliacion({ cu, isMobile }) {
  ...
  return (
    <div>
      ...
      {subTab === 'cartolas'   && <ImportadorCartola onImportado={() => showToast('Cartola importada — ve a Clasificar para procesar los movimientos')} />}
