...
export function FinConciliacion({ cu, isMobile }) {
  ...
  // Pestañas agrupadas en 4 etapas del flujo de conciliación:
  // Clasificar (preparar) → Diagnosticar (ver qué falta) → Conciliar (actuar) → Consultar (datos)
  const GRUPOS = [
    {
      g: 'clasificar', label: '1 · Clasificar', color: '#64748B',
      tabs: [
    ...
    {
      g: 'diagnosticar', label: '2 · Diagnosticar', color: '#1F4E79',
      tabs: [
    ...
    {
      g: 'conciliar', label: '3 · Conciliar', color: '#7C3AED',
      tabs: [
    ...
    {
      g: 'consultar', label: '4 · Consultar', color: '#0F6E56',
      tabs: [
