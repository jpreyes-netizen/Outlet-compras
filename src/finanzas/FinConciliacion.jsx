...
export function FinConciliacion({ cu, isMobile }) {
  const [subTab, setSubTab] = useState(() => {
    try { const g = localStorage.getItem('fin_conc_goto'); if (g) { localStorage.removeItem('fin_conc_goto'); return g } } catch (e) { }
    return 'imputar'
  })
  ...
  return (
    <div>
      ...
      {subTab === 'vincular_oc'   && <VincularOC cu={cu} />}
