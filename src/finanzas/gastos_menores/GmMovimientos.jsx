...
export function GmMovimientos({ cu, isMobile }) {
  ...
  const guardar = async () => {
    ...
    try {
      ...
      if (esRetroactivo) {
        // Recalcular cadena completa de saldos en orden cronológico determinista.
        // El desempate por 'id' es OBLIGATORIO: los movimientos migrados en batch
        // comparten created_at, y sin desempate el orden es no determinista.
        ...
        // El acumulado parte del saldo_inicial del fondo, no de 0
        let saldoAcum = fondo.saldo_inicial || 0
        ...
        toast.info(`Fecha retroactiva — ${updates.length} saldos recalculados`, { duration: 3000 })
