  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{
        ...
        <button onClick={() => handleSync(true)} disabled={syncing || loading} title="Re-sincroniza TODO el mes (sobrescribe cache)"
          style={{
            background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: '#fff',
            padding: '7px 10px', borderRadius: 7, cursor: syncing ? 'wait' : 'pointer',
            fontSize: 11, fontWeight: 500, opacity: 0.85
          }} title="Forzar re-sincronización completa del mes">
          🔄 Todo
        </button>
