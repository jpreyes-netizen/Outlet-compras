...
// Sincroniza un rango específico de fechas (puede ser 1 día o varios)
// Paraleliza en batches de 5 para mayor velocidad
export async function sincronizarRango({ fechaDesde, fechaHasta, sucursal_id, onProgress }) {
  ...
  // Generar todos los días L-S del rango
  const dias = []
  const hoy = new Date().toISOString().split('T')[0]
