        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'stretch' }}>
          ...
          <aside style={{
            ...
            <div style={{ padding: '12px 20px', borderTop: '1px solid #F3F4F6', display: 'flex', justifyContent: 'flex-end', gap: 8, flexShrink: 0, background: '#fff' }}>
              ...
              <button onClick={handleCorrob} disabled={savingCorrob}
                style={{ ...btnSt(), background: '#DC2626' }}>
                DEBUG CORROB (esAdmin:{String(esAdmin)} estado:{panelVendedor.cierre?.estado} vc:{String(!!valoresCorrob)})
              </button>
            </div>
          </aside>
        </div>
