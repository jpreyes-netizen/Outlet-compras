        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <button onClick={() => setVistaExcel(true)} title="Vista Excel: ordenar, filtrar, exportar"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '5px 10px', borderRadius: 10, border: '1px solid #E2E8F0', background: '#fff', fontSize: 11, fontWeight: 600, color: '#475569', cursor: 'pointer' }}>
              <Table2 size={12} /> Vista Excel
            </button>
