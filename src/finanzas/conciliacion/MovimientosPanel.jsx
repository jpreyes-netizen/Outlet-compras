...
import { Search, RefreshCw, Wand2, Loader2 } from 'lucide-react'
      ...
      <div style={{ borderBottom: '1px solid #E2E8F0', padding: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <button onClick={onAutoMatch} disabled={autoRunning || loading}
              style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '5px 10px', borderRadius: 10, border: 'none', background: 'linear-gradient(to bottom, #6366F1, #4F46E5)', fontSize: 11, fontWeight: 600, color: '#fff', cursor: 'pointer', opacity: autoRunning || loading ? 0.5 : 1 }}>
              {autoRunning ? <Loader2 size={11} /> : <Wand2 size={11} />} Auto-conciliar
            </button>
