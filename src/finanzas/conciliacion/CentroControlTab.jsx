        ...
        <tbody>
          {filtradas.map(r => (
            <tr key={r.rut_clave} style={{ borderTop: '1px solid #F1F5F9' }}>
              <td style={{ padding: '7px 8px', fontFamily: 'monospace', color: '#475569' }}>{r.tiene_rut === false ? '—' : r.rut_clave}</td>
              ...
              <td style={{ padding: '7px 8px' }}>
                {r.tiene_rut === false ? (
                  <span title="Clasificado automáticamente por patrón de glosa" style={{
                    fontSize: 11, padding: '3px 8px', borderRadius: 6,
                    border: `1px solid ${r.categoria_color || '#E2E8F0'}`,
                    background: (r.categoria_color || '#64748B') + '12',
                    color: r.categoria_color || '#64748B', fontWeight: 600,
                    display: 'inline-block', maxWidth: 170, overflow: 'hidden',
                    textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                  }}>{r.categoria_label || r.categoria} · patrón</span>
                ) : (
