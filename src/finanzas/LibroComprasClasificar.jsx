      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, minWidth: 280, background: '#F0F4FF', border: '1px solid #C7D2FE', borderRadius: 8, padding: '7px 12px', fontSize: 11.5, color: '#1E3A8A', lineHeight: 1.5 }}>
          {esProv
            ...
            : <><b>Excepciones por factura.</b> Cambiar la cuenta aquí afecta solo a esa factura; la regla del proveedor se administra en el nivel Proveedores. Vencimiento = emisión + plazo del proveedor; las notas de crédito se muestran en negativo.</>}
        </div>
      </div>
