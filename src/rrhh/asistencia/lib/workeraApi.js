...
// Invocación de la Edge Function workera-proxy.
...
/**
 * Llama a la Edge Function workera-proxy con la acción solicitada.
...
export async function callWorkera(action, params = {}) {
  ...
  const url = `${SUPABASE_URL}/functions/v1/workera-proxy`
  let response
  try {
