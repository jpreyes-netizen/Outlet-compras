...
// Panel de sync manual: catálogos, empleados, marcaciones, permisos, hhee, horarios.
  ...
  return (
    <div>
      ...
      <p style={{color:"var(--text-muted)", fontSize:13, margin:"0 0 24px 0"}}>
        Ejecuta sincronizaciones puntuales con Workera. Todas las acciones quedan registradas en el log.
      </p>
      ...
      <section style={{marginBottom:24}}>
        ...
        <p style={{fontSize:12, color:"var(--text-muted)", margin:"8px 0 0 0"}}>
          ⚠️ Horarios esperados tiene un límite de 60 días por consulta en Workera.
        </p>
      </section>
      ...
      <div style={{
        ...
        <strong style={{color:"var(--accent)"}}>💡 Flujo recomendado de sync mensual:</strong>
        {" "}Empleados → Horarios esperados → Marcaciones → Permisos.
        Las horas extra y atrasos se calculan automáticamente en el tab Extra/Atrasos.
      </div>
