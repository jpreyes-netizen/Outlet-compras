...
export function AsisHHEE({ cu, scopeSuc, initDominio, initCat, onCambio }) {
  ...
  async function cargar() {
    ...
    try {
      ...
      let qE = supabase.from('v_asis_jornadas')
        .select('cod_contaline,empleado,fecha,sucursal_id,sucursal_nombre,min_antes_turno_contable,workshift_name,entrada_real,entrada_esperada')
      ...
      let qJ = supabase.from('v_asis_jornadas')
        .select('cod_contaline,empleado,fecha,sucursal_id,sucursal_nombre,estado_dia,min_extra_dia,workshift_name,entrada_real,salida_real,extra_reparo')
        .gt('min_extra_dia', 0)
      ...
      let qA = supabase.from('v_asis_jornadas')
        .select('cod_contaline,empleado,fecha,sucursal_nombre,workshift_name,novedad_tipo')
  ...
  const filasEnt = useMemo(() => jorEntrada.map(j => {
