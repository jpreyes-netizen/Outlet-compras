...
export function AsisDashboard({ cu, onIrASync, scopeSuc }) {
  ...
  return (
    <div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(150px,1fr))',gap:10,marginBottom:20}}>
        ...
        {!scopeSuc && data.sinMapear > 0 && <Kpi ic="🔗" l="Sin mapear" v={data.sinMapear} sub="requieren acción" c="#FF3B30" alerta/>}
      </div>
