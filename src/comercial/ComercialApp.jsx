      ...
      <div style={{ padding: isMobile ? '12px 12px 40px' : '18px 22px 48px', maxWidth: 1280, margin: '0 auto' }}>
        {loadingBase ? (
          ...
          <>
            ...
            {tab === 'bitacora' && <TabBitacora {...{ sucursales, sucSel, setSucSel, anio, setAnio, mes, setMes, isMobile }} />}
...
function TabBitacora({ sucursales, sucSel, setSucSel, anio, setAnio, mes, setMes, isMobile }) {
