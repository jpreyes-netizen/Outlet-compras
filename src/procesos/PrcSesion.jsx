      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(420px, 1fr))', gap: 13 }}>
        ...
        <Cd>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8, flexWrap: 'wrap' }}>
            ...
            {editable && puedeDecidir && <Bt sm style={{ marginLeft: 'auto' }} onClick={() => setSheet('encargo')} title="Encarga un proceso a un comité de trabajo (P37): líder, integrantes y plazo de 2 meses. Queda registrado como decisión de esta sesión.">＋ Asignar proceso</Bt>}
          </div>
