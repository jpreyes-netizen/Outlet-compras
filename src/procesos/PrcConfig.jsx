        ...
        {reg && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 11 }}>
            ...
            <Campo l="Integrantes permanentes" hint="Se sugieren al convocar. Impar, mínimo 3, al menos uno de otra dirección (principios 5 y 7).">
              <ChipsPersonas valores={reg.integrantes || []} onChange={v => setReg({ ...reg, integrantes: v })}
                personas={personas} ctx={{ comites: cat.comites || [], encargos: [], sesiones: [] }}
                propuesta={{ codigo: reg.codigo, dia_semana: reg.dia_semana, hora_inicio: reg.hora_inicio, hora_fin: reg.hora_fin, duracion_min: reg.duracion_min }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 9 }}>
              <Campo l="Secretario/a de actas" hint="Por nombre, no por área (principio 6).">
                <SelPersona valor={reg.secretario} onChange={v => setReg({ ...reg, secretario: v })} personas={personas}
                  soloDeLista={reg.integrantes || []} permitirLibre={false} dis={!admin} ph="— elegir —" />
              </Campo>
