        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
          <Cd>
            ...
            <ul style={{ fontSize: 12.5, lineHeight: 1.8, margin: '10px 0 0 18px' }}>
              ...
              <li><b>Piloto de 2 semanas.</b> Un comité de trabajo no acepta fechas de piloto con menos de 14 días (P37, principio 10).</li>
              <li><b>Plazo de 2 meses.</b> Todo encargo nace con fecha límite a 2 meses y sus 7 fases con fecha meta (P37, principio 11).</li>
