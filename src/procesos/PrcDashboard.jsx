...
import { Cd, Mt, Bd, Barra, css, pct, SEMAFORO, Criterios, Vacio, fFecha, Ayuda } from './prcUI'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Ayuda k="dash" titulo="Cómo leer este dashboard">
        Es la vista de gobierno de los 22 procesos clave. El <b>avance ponderado</b> pesa cada proceso por su score,
        así que refleja el avance donde importa y no el promedio simple. <b>Prioridad de ataque</b> y <b>Alertas</b> son
        listas clickeables: cada fila te lleva a la ficha del proceso. Si un número te sorprende, ábrelo y revisa su
        pestaña Avance para ver quién lo declaró y cuándo.
      </Ayuda>
