...
function shell(fase, codigo, titulo, enc, cuerpo, op = {}) {
...
<tr>
  ...
  <td bgcolor="${AZUL2}" style="padding:10pt 14px;border:1pt solid ${AZUL2}">
    ...
    <span style="color:#9fb0d8;font-size:8pt">SOP P21 · Construcción y aprobación de procesos · ${op.subtitulo ? esc(op.subtitulo) : `Fase ${fase}`}</span>
  </td>
...
${esc(codigo)}-P21 v1.0 · Outlet de Puertas SpA · Documento controlado del Sistema de Gestión de Procesos — una copia impresa o descargada es copia no controlada; la versión vigente vive en el ERP. ${op.nota ? esc(op.nota) : `El documento rellenado y exportado a PDF es el entregable oficial de la fase ${fase}: cárguelo como evidencia en el encargo (Procesos → Comités de trabajo).`}
</p>
</body></html>`
}
...
// piezas compartidas con los formatos por paso (prcFormatosPaso.jsx)
export const piezas = { shell, sec, T, th, td, tdv, filasVacias, ej, filaDato, cajaTexto, escala, checklist, aprobaciones, instrucciones, proposito, esc, fF, AZUL, GRISX, BORDE, EJ, MUTED }
