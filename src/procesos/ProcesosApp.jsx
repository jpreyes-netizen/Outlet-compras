  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-page)' }}>
      ...
      <main style={{ padding: '20px 24px 60px', maxWidth: sel ? 1500 : 1600, margin: '0 auto' }}>
        ...
        {!loading && sel && (
          <PrcFicha id={sel} cu={cu} cat={cat} matriz={matriz} deps={deps} onCerrar={cerrarFicha} onAbrir={abrir} toast={toast} />
        )}
        {!loading && !sel && tab === 'dashboard'   && <PrcDashboard matriz={matriz} cat={cat} alertas={alertas} onAbrir={abrir} />}
