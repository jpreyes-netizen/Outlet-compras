...
function OCDetView({oc,firmas,pagos,provs=[],updOC,addFirma,setPagos,close,cu,h,config={}}){
  ...
  return<div>
    ...
    {(items.length>0||addingItem)&&<><div id={"oc-productos-"+oc.id} style={{fontSize:15,fontWeight:700,marginBottom:6,display:"flex",justifyContent:"space-between",alignItems:"center",scrollMarginTop:20}}>
