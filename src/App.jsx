  ...
  return<div>
    ...
    {configTab==="params"&&<div>
      ...
      <Cd s={{marginTop:10}}><div style={{fontSize:15,fontWeight:700,marginBottom:4}}>Parámetros avanzados del algoritmo</div>
        ...
        <div style={{marginTop:12,background:"#FFF4E5",borderRadius:10,padding:12,fontSize:12,color:"#8E6D3B",lineHeight:1.5,border:"1px solid #FF950030"}}>
          ⚠️ <strong>Importante:</strong> Los cambios aplican en la próxima sincronización BSALE. Si ya cargaste el reporte, re-sube el Excel para recalcular con los nuevos parámetros.
        </div>
      </Cd>
    </div>}
