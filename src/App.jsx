...
export default function App(){
  ...
  return<div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Display',system-ui,sans-serif",margin:0,padding:"0 20px 100px",background:"#F2F2F7",minHeight:"100vh",fontSize:14}}>
    ...
    {tab==="calendario"&&<CalendarioView prods={prodsWithTransit} ocs={ocs}/>}
...
function OCDetView({oc,firmas,pagos,updOC,addFirma,setPagos,close,cu,h,provs=[]}){
  ...
  return<div>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,gap:8}}>
      <div style={{fontSize:12,color:"#8E8E93"}}>Documento oficial · Listo para enviar al proveedor</div>
      <Bt v="pri" sm onClick={descargarPDF} dis={pdfLoading||items.length===0} ic="📄">{pdfLoading?"Generando...":"Descargar PDF"}</Bt>
    </div>
    <Stp steps={isI?FI:FN} cur={oc.fase_actual}/>
