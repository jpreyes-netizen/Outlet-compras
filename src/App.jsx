...
La OC original pasará a estado "Dividida".`))return
    ...
    try{
      ...
      const ocA={...base,id:idA,fecha_creacion:hoy(),
        ...
        total_clp:isI?Math.round(totalA*TC_USD):Math.round(totalA),
        total_neto:!isI?Math.round(totalA/1.19):0,
        iva_monto:!isI?Math.round(totalA-totalA/1.19):0,
        fecha_estimada:splitEtaA
      }
      const ocB={...base,id:idB,fecha_creacion:hoy(),
        total_usd:isI?Math.round(totalB):0,
        total_clp:isI?Math.round(totalB*TC_USD):Math.round(totalB),
        total_neto:!isI?Math.round(totalB/1.19):0,
        iva_monto:!isI?Math.round(totalB-totalB/1.19):0,
