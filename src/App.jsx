            ...
            {filas.map(fila=>{
              ...
              return<>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:6,cursor:expandable?"pointer":"default",minWidth:0}}>
                      ...
                      <div style={{minWidth:0,flex:1}}>
                        ...
                        <div style={{fontSize:10,color:"#AEAEB2",marginTop:1}}>
                          ...
                          <span style={{color:"#5856D6",fontWeight:600}}>{fN(fila.ventaMes)}/mes</span>
                          {!fila.sinVenta&&<span style={{color:"#007AFF",marginLeft:6,fontWeight:600}}>fab {fila.diasFab}d</span>}
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                {isHoverRow&&!fila.sinVenta&&<tr>
                  <td colSpan={meses.length+3} style={{padding:0,border:"none"}}>
                ...
                {expandable&&estaExpandido&&fila.prods.slice(0,25).map(({p,proy})=>{
                  return<tr key={fila.key+"-"+p.sku}>
                    <td style={{padding:"4px 8px 4px 32px",background:"#FAFAFA",position:"sticky",left:0,zIndex:1,borderBottom:"1px solid #F2F2F7"}}>
                      ...
                      <div style={{fontSize:9,color:"#AEAEB2",marginTop:1}}>{p.sku} · <span style={{color:"#5856D6"}}>{fN(proy.ventaMes)}/mes</span> · fab {proy.diasFab}d</div>
                    </td>
                ...
                {expandable&&estaExpandido&&fila.prods.length>25&&<tr>
                  <td colSpan={meses.length+3} style={{padding:"4px 8px 4px 32px",background:"#FAFAFA",fontSize:10,color:"#8E8E93",fontStyle:"italic"}}>
