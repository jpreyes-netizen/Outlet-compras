...
function CoberturaView({prods=[],ocs=[],config={},params=[],paramsABCD=[]}){
  ...
  const colorZona=(cel)=>{
    if(cel.zona==="sin_venta")return{bg:"#F2F2F7",c:"#8E8E93",label:"—"}
    if(cel.zona==="quiebre")return{bg:"repeating-linear-gradient(45deg,#4B0000,#4B0000 4px,#FF3B30 4px,#FF3B30 8px)",c:"#fff",label:"0%"}
    if(cel.zona==="emergencia")return{bg:"#FF9500",c:"#fff",label:Math.round(cel.cobertura*100)+"%"}
    if(cel.zona==="reorden")return{bg:"#FFD60A",c:"#5A4600",label:Math.round(cel.cobertura*100)+"%"}
    // zona normal: verde intenso si cubre 100%, verde suave si no
    ...
    return{bg:"#FF9500",c:"#fff",label:Math.round(cel.cobertura*100)+"%"}
  }
  ...
  return<div onMouseLeave={()=>{setHoverCell(null);setHoverItem(null)}}>
    ...
    <div style={{display:"flex",gap:10,flexWrap:"wrap",fontSize:11,marginBottom:10,padding:"10px 14px",background:"#fff",borderRadius:8,alignItems:"center"}}>
      ...
      <span style={{display:"inline-flex",alignItems:"center",gap:4}}><span style={{width:14,height:14,background:"#34C759",borderRadius:3}}/>Normal</span>
      <span style={{display:"inline-flex",alignItems:"center",gap:4}}><span style={{width:14,height:14,background:"#FFD60A",borderRadius:3}}/>Reorden</span>
      <span style={{display:"inline-flex",alignItems:"center",gap:4}}><span style={{width:14,height:14,background:"#FF9500",borderRadius:3}}/>Emergencia</span>
      <span style={{display:"inline-flex",alignItems:"center",gap:4}}><span style={{width:14,height:14,background:"repeating-linear-gradient(45deg,#4B0000,#4B0000 3px,#FF3B30 3px,#FF3B30 6px)",borderRadius:3}}/>Quiebre</span>
                    ...
                    return<td key={i} style={{padding:0,borderBottom:"1px solid #F2F2F7"}}>
                      <div
                        ...
                        style={{
                          ...
                          cursor:"help",
                          border:cel.contieneQuiebre?"2px solid #4B0000":cel.contieneEmerg?"2px solid #CC6600":cel.contieneReorden?"2px solid #A07D00":"none",
                          zIndex:isHover?5:1
                        }}>
