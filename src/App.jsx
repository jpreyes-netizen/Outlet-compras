...
function TooltipFormula({it,mNames}){
  ...
  const fab=it.dias_fabricacion||0
  const emerg=it.dias_emergencia||0
  const cob=it.periodo_cubrir||0
...
function CoberturaView({prods=[],ocs=[],config={},params=[],paramsABCD=[]}){
  ...
  const getParams=(p)=>{
    ...
    return{
      diasFab:p.dias_fabricacion||tp?.dias_fabricacion||30,
      periodoCob:p.periodo_cubrir||tp?.periodo_cobertura||90,
      diasEmerg:p.dias_emergencia||abcd?.dias_emergencia||5
    }
  }
