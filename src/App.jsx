...
export default function App(){
  ...
  useEffect(()=>{try{if(appActual)localStorage.setItem("outlet_app_actual",appActual);else localStorage.removeItem("outlet_app_actual")}catch(e){}},[appActual])
  ...
  if(!appActual)return<AppHub cu={cu} onSelect={setAppActual}/>
  if(appActual==="finanzas")return<FinanzasApp cu={cu} setAppActual={setAppActual}/>
    ...
    <div style={{position:"sticky",top:0,zIndex:50,background:"rgba(242,242,247,0.9)",backdropFilter:"blur(20px)",padding:isMobile?"10px 0 8px":"14px 0 10px",marginBottom:10,borderBottom:"1px solid rgba(0,0,0,0.06)"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:isMobile?4:8,flexShrink:0}}>
          ...
          <button onClick={()=>{localStorage.removeItem("outlet_app_actual");setAppActual(null)}} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:1,padding:isMobile?"6px 8px":"6px 10px",borderRadius:10,background:"#34C75915",border:"none",cursor:"pointer",color:"#34C759",minWidth:isMobile?42:56}} title="Cambiar de aplicación">
            <span style={{fontSize:isMobile?13:14,lineHeight:1}}>⇄</span>
...
function OCDetView({oc,firmas,pagos,provs=[],updOC,addFirma,setPagos,close,cu,h,config={},notificarFlujo,ROL_POR_ESTADO={},setTab}){
  ...
  return<div>
    ...
    {(()=>{
      ...
      const camposBase=[["Proveedor",oc.proveedor_id],["Tipo",oc.tipo_oc],["Total",totalStr],["Pago",oc.condicion_pago]]
