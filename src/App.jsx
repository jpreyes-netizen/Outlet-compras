...
La OC original ${oc.id} quedó en estado "Dividida".`)
  ...
  const exportarPDF=async()=>{
    ...
    try{
      ...
      doc.setFont("helvetica","bold");doc.setFontSize(10);doc.text("Bitácora ("+bitacora.length+" eventos)",M,y);y+=4
      autoTable(doc,{
        startY:y,
        head:[["Fecha","Usuario","Rol","Acción"]],
        body:bitacora.map(b=>[b.fecha,b.usuario,b.rol,b.accion]),
        styles:{fontSize:7.5,cellPadding:2},
        headStyles:{fillColor:[26,26,46],textColor:[255,255,255],fontStyle:"bold"},
        columnStyles:{0:{cellWidth:26},1:{cellWidth:24},2:{cellWidth:22},3:{cellWidth:"auto"}},
        margin:{left:M,right:M}
      })
