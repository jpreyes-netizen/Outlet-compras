...
function PagosEditor({oc,pagos,setPagos,cu,puedeEditar,addFirma}){
...
function OCDetView({oc,firmas,pagos,provs=[],updOC,addFirma,setPagos,close,cu,h}){
  ...
  return<div>
    ...
    {pagos.length>0&&(()=>{
      ...
      return<PagosEditor oc={oc} pagos={pagos} setPagos={setPagos} cu={cu} puedeEditar={puedeEditarPagos} addFirma={addFirma}/>
    })()}
