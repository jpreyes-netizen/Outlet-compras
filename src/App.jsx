...
function RepoView({prods,cart,setCart,go,config,params,paramsABCD}){
  ...
  return<div>
    ...
    <div style={{display:"flex",gap:6,marginBottom:10}}>
      ...
      <select value={fe} onChange={e=>setFe(e.target.value)} style={{...css.select,width:130}}><option value="T">Todos estados</option><option value="Reposición">Reposición</option><option value="Stock suficiente">Stock suficiente</option><option value="Sin ventas">Sin ventas</option><option value="Revisar">Revisar</option></select>
