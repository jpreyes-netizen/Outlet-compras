...
function ETAReprog({oc,updOC,addFirma,cu}){
  ...
  return<div style={{background:"#F2F2F7",borderRadius:10,padding:"8px 12px"}}>
    ...
    {edit
      ...
      :<div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:4}}>
        ...
        {!recibida&&<button onClick={()=>{setVal(oc.fecha_estimada||"");setEdit(true)}}
  ...
  return<div>
    ...
    {(()=>{
      ...
      return<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:14}}>
        ...
        <ETAReprog oc={oc} updOC={updOC} addFirma={addFirma} cu={cu}/>
        {/* Destino editable */}
