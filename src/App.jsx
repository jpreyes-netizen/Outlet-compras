    ...
    try{
      ...
      autoTable(doc,{
        ...
        body:[
          ...
          [`4. Aduana (arancel ${par.tieneTLC?"TLC 0":par.pctArancel}% + IVA ${par.pctIVA}%)`,fN(adValorem_USD+iva_USD),fmt(toCLP(adValorem_USD+iva_USD))],
          [`5. Gastos en puerto (${par.contenedores} contenedor/es)`,fN(puerto),fmt(toCLP(puerto))],
          ...
          [{content:"TOTAL IMPORTACIÓN",styles:{fontStyle:"bold"}},{content:fN(totalImport_USD),styles:{fontStyle:"bold"}},{content:fmt(toCLP(totalImport_USD)),styles:{fontStyle:"bold"}}],
        ],
