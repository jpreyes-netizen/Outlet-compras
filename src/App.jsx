...
/* ═══ MAIN APP ═══ */
const TABS=[{k:"monitor",l:"Monitor",ic:"📊"},{k:"repo",l:"Reposición",ic:"📦"},{k:"forecast",l:"Forecast",ic:"📈"},{k:"costeo",l:"Costeo IMP",ic:"🧮"},{k:"transito",l:"Tránsito",ic:"🚚"},{k:"finanzas",l:"Finanzas",ic:"💰"},{k:"nueva",l:"Nueva OC",ic:"➕"},{k:"ordenes",l:"Órdenes",ic:"📋"},{k:"flujograma",l:"Flujograma",ic:"🔄"},{k:"config",l:"Config",ic:"⚙️"}]
...
export default function App(){
  ...
  return<div style={{fontFamily:"-apple-system,BlinkMacSystemFont,'SF Pro Display',system-ui,sans-serif",margin:0,padding:"0 20px 100px",background:"#F2F2F7",minHeight:"100vh",fontSize:14}}>
    ...
    {tab==="nueva"&&<SolView cart={cart} setCart={setCart} provs={provs} users={users} sucursales={sucursales} cu={cu} setOcs={setOcs} addFirma={addFirma} goOC={()=>setTab("ordenes")} ocs={ocs}/>}
...
function SolView({cart,setCart,provs,users,sucursales=[],cu,setOcs,addFirma,goOC,ocs}){
...
function OCDetView({oc,firmas,pagos,provs=[],updOC,addFirma,setPagos,close,cu,h}){
  ...
  return<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:14}}>
      {(()=>{const destino=provs.length>0?null:null;const suc=oc.destino_sucursal_id;return[["Proveedor",oc.proveedor_id],["Tipo",oc.tipo_oc],["Total",fmt(oc.total_clp)],["ETA",oc.fecha_estimada||"—"],["Destino",suc||"CD Maipú"],["Pago",oc.condicion_pago]]})().map(([l,v],i)=><div key={i} style={{background:"#F2F2F7",borderRadius:10,padding:"8px 12px"}}><div style={{fontSize:10,color:"#AEAEB2",fontWeight:600}}>{l}</div><div style={{fontSize:13,fontWeight:600,color:"#1C1C1E"}}>{v}</div></div>)}
    </div>
...
function ConfigView({config,saveConfig,params,setParams,paramsABCD,setParamsABCD,provs,setProvs,users,setUsers,sucursales=[],setSucursales,h,configTab,setConfigTab,loadAll,cu}){
  const isAdmin=cu?.rol==="admin"||cu?.rol==="dir_general"
  const allTabs=[{k:"params",l:"Reposición",ic:"📊",all:true},{k:"bsale",l:"BSALE",ic:"🔗",all:true},{k:"provs",l:"Proveedores",ic:"🏢",all:true},{k:"sucursales",l:"Sucursales",ic:"🏬",all:false},{k:"users",l:"Usuarios",ic:"👤",all:false},{k:"permisos",l:"Permisos",ic:"🔑",all:false}]
