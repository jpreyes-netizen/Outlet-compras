    ...
    <div style={{ fontFamily: FONT, margin: 0, padding: embedded ? "0 0 70px" : (isMobile ? "0 10px 60px" : "0 20px 80px"), background: embedded ? "transparent" : "#f4f5f9", minHeight: embedded ? undefined : "100vh", fontSize: 14 }}>
      ...
      {!showRapidaMia && (
        <button onClick={() => { setRmForm({ titulo: "", resp: "", fecha: "" }); setShowRapidaMia(true) }} title="Nueva tarea rápida"
          style={{ position: "fixed", right: 18, bottom: embedded && isMobile ? "calc(84px + env(safe-area-inset-bottom, 0px))" : 18, width: 52, height: 52, borderRadius: 999, background: NAVY, color: "#fff", border: "none", cursor: "pointer", fontSize: 25, lineHeight: "52px", boxShadow: "0 6px 20px rgba(22,33,62,0.4)", zIndex: 90 }}>+</button>
      )}
