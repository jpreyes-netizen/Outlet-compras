      ...
      <div style={card}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
            ...
            <button onClick={sincronizarNombres} disabled={running} style={{ padding: "8px 14px", borderRadius: 10, border: "1.5px solid " + accent, background: "#fff", color: accent, fontWeight: 700, fontSize: 12.5, cursor: running ? "default" : "pointer", opacity: running ? 0.5 : 1 }}>
              🏷️ Sincronizar nombres BSALE
            </button>
          </div>
