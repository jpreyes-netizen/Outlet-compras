...
const ACCION_META = {
  ...
  TRANSFERIR_CD:   { l: "Transferir desde Maipú", ic: "🚚", c: "#FF9500", desc: "Maipú (CD) tiene stock que una sucursal necesita. Transferir en vez de comprar — resuelve el faltante sin costo nuevo." },
  RIESGO_QUIEBRE:  { l: "Riesgo de quiebre", ic: "⏳", c: "#FFCC00", desc: "Cobertura menor al lead time del proveedor. Reponer antes de quebrar." },
...
const ORDEN = ["COMPRAR_URGENTE", "TRANSFERIR_CD", "RIESGO_QUIEBRE", "REBALANCEAR", "GMROI_BAJO", "LIQUIDAR", "SOBRESTOCK"]
