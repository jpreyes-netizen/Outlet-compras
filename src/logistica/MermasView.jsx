...
export function MermasView({ cu, sucs, soloSuc = null }) {
  ...
  const sinAlcance = soloSuc === '__sin_sucursal__' || soloSuc === '__sin_usuario__'
  const sucPropia = sinAlcance ? null : normSuc(soloSuc)
  ...
  const cargar = async () => {
    ...
    try {
      ...
      if (sucPropia) q = q.eq('sucursal_codigo', sucPropia)
