...
function PickingView({cu, sucs}) {
  ...
  const listaPickingPDF = async ()=>{
    ...
    autoTable(doc,{ startY:y, styles:{fontSize:10.5,cellPadding:3.4}, headStyles:{fillColor:[26,26,46],fontSize:9.5},
      ...
      columnStyles:{0:{cellWidth:11,halign:'center',fontStyle:'bold'},1:{cellWidth:36,fontSize:9},
        3:{cellWidth:18,halign:'right',fontStyle:'bold',fontSize:12}},
    ...
    doc.line(24, fy, 96, fy)
    doc.line(114, fy, 186, fy)
    doc.setFontSize(8); doc.setFont(undefined,'bold'); doc.setTextColor(40,40,55)
    doc.text('FIRMA PICKEADOR QUE ENTREGA', 60, fy+4.5, {align:'center'})
    doc.text('RECIBE CONFORME', 150, fy+4.5, {align:'center'})
    doc.setFontSize(8); doc.setFont(undefined,'normal'); doc.setTextColor(90,90,110)
    doc.text(sel.pickeador_nombre||'Nombre: ______________________', 60, fy+9, {align:'center'})
    doc.text('Nombre / RUT: ______________________', 150, fy+9, {align:'center'})
