...
function PickingView({cu, sucs}) {
  ...
  // o vendedor. Los contadores de las dos bandejas pasan a mostrar coincidencias,
  // así se ve al tiro si el documento buscado está en la otra bandeja.
  ...
  const pasaTxt = o=>{
    ...
    return [o.cliente_nombre,o.cliente_rut,o.receptor_nombre,o.receptor_rut,o.guia_numero,
            ...
            o.vendedor_nombre,o.pickeador_nombre,o.chofer_nombre]
  ...
  // Coincidencias en la bandeja que NO se está viendo (para avisar dónde está el doc)
  const nOtraBandeja = busq ? (bandeja==='programada'?inmediatas.length:programadas.length) : 0
                      ...
                      ? <>🔍 Sin coincidencias para <b style={{color:'#1C1C1E'}}>«{colaTxt.trim()}»</b> en esta bandeja
                          {nOtraBandeja>0&&(
                            <div style={{marginTop:8}}>
                              <button onClick={()=>setBandeja(bandeja==='programada'?'inmediata':'programada')}
                                style={{padding:'6px 14px',borderRadius:9,border:'none',cursor:'pointer',fontSize:11.5,fontWeight:900,
                                  background:bandeja==='programada'?'#007AFF':'#5856D6',color:'#fff'}}>
                                {nOtraBandeja} en {bandeja==='programada'?'⚡ ENTREGA INMEDIATA':'🚚 POR DESPACHAR'} → ver
                              </button>
                            </div>)}
